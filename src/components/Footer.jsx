      ...
      <div className="flex justify-between align-center gap-10 px-24 py-20">
          ...
          <div>
            <p className="font-extrabold text-4xl mb-5">Valubah</p>
              ...
              <div className="mt-6">
                <input type="text" placeholder="Enter your email" className="h-[3rem] bg-[#2B2E3C]  text-grayy-300 p-2 hover:border-none focus:border-none active:border-none" /><span className="bg-[#FBCBC9] p-3 font-medium text-gray-700 rounded-sm">
                Get Started
                  </span>  
              </div>
          </div>
        ...
        <div className="mx-20 flex gap-4 mt-3">
          ...
          <div className="mb-6 mt-[-2rem]"> Copyright Valubah 2023
            <span className="flex">
              <img />
              <img />
              <img />
